...
class Property(TimeStampedUUIDModel):
    ...
    class PropertyType(models.TextChoices):
        HOUSE = "House", _("House")
        APPARTMENT = "Appartment", _("Appartment")
    ...
    price = models.DecimalField(verbose_name = _("Proce"), max_digits=8, decimal_places=2, default=0.0)
    tax = models.DecimalField(verbose_name=_("Property Tax"), max_digits=6, decimal_places=2, default=0.15, help_text=_("15% property tax charged"))
    ...
    advert_type = models.CharField(verbose_name=_("Adevrt Type"), max_length=50, choices=AdvertType.choices, default=AdvertType.FOR_SALE)
    ...
    def final_property_price(self):
        tax_percenatge = self.tax
        property_price = self.price
        tax_amount = round(tax_percenatge * property_price, 2)
...
class PropertyViews(TimeStampedUUIDModel):
    ...
    def __str__(self):
        return (f"Total views on - {self.property.title} is - {self.property.views} views")
